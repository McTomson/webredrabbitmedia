...
export const metadata: Metadata = {
    title: "Webdesign Wien: Exklusiver Look, fairer Preis | ab 790€",
    description: "Ihre neue Website in 7 Tagen. Premium-Design ohne Agentur-Aufschlag. Null Risiko: Erst Entwurf prüfen, dann entscheiden. Top Service.",
    alternates: {
