...
export const metadata: Metadata = {
    title: "Webdesign Salzburg: Weltklasse Design, Lokal betreut",
    description: "Ein Auftritt mit Stil für Salzburger Betriebe. Ab 790€. Exklusiv, elegant & effektiv. Zahlen Sie nur bei 100% Zufriedenheit.",
    alternates: {
