...
export default function SalzburgPage() {
  ...
  const regionalData = {
    ...
    population: "560.000",
    cities: ["Salzburg", "Hallein", "St. Johann", "Zell am See", "Saalfelden"],
    landmarks: ["Festung Hohensalzburg", "Getreidegasse", "Mirabellgarten", "Mozarthaus"],
    keywords: "Webdesign Salzburg, Homepage Salzburg, Website Salzburg",
  };
