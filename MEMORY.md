...
- **NÄCHSTE SCHRITTE (Plan-Reihenfolge):** Kill-Switch (Indexierungsrate < Schwelle pausiert Tageslauf) → Conversion-Events (GA4/GTM). Dann Phase 2 (/interview-me + Vault), Phase 3 Pilot-Cluster Kosten beweisen. Optional: Tremor-Sparklines/Charts ins Dashboard.
