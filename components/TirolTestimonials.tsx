...
const testimonials = [
    {
        name: "Andreas Hofer jun.",
        company: "Alpine Lodge Tirol",
        location: "Kitzbühel",
        rating: 5,
        text: "Tiroler Qualität zeigt sich auch digital. Red Rabbit Media hat unsere Vision eines modernen Alpin-Resorts perfekt ins Netz gebracht. Die Performance ist so stark wie unsere Berge.",
        service: "Hotel & Gastronomie"
    },
    {
        name: "Mag. Claudia Steiner",
        company: "Tirol Consulting Group",
        location: "Innsbruck",
        rating: 5,
        text: "Wer im Inntal Erfolg haben will, braucht einen Partner auf Augenhöhe. Die unkomplizierte Abwicklung und das erstklassige Webdesign haben uns voll überzeugt.",
        service: "Beratung"
    },
    {
        name: "Stefan Plattner",
        company: "Plattner Haustechnik",
        location: "Kufstein",
        rating: 5,
        text: "Ehrlich, direkt und technisch einwandfrei. Unsere neue Website ist so zuverlässig wie unsere Arbeit. Ein echter Gewinn für unseren Betrieb in Tirol.",
        service: "Handwerk"
    }
];

export default function TirolTestimonials() {
            ...
            <div className="max-w-4xl mx-auto px-8 text-center">
                ...
                >
                    <h2 className="text-3xl lg:text-4xl font-light text-gray-900 mb-4 tracking-tight">
                        Das sagen unsere <span className="text-red-600 font-medium">Tiroler Kunden</span>
                    </h2>
                </motion.div>
