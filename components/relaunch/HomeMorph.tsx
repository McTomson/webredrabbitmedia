...
export default function HomeMorph() {
  ...
  useEffect(() => {
    ...
    // Navy-Traveler: EIN durchgehendes dunkles Teil, das durch alle 5 Figuren
    // wandert (Tomson 05.07.). navyRest = Ruhe-Bildschirmposition je Szene,
    // navyEl = das eine Traveler-Element, navyHide = Pool-Indizes der Original-
    // Navy-Teile (werden versteckt, der Traveler ersetzt sie).
    ...
    function build() {
      ...
      // ---- Navy-Traveler aufbauen (Tomson 05.07.): EIN dunkles Teil wandert
      // durch die Navy-Slots aller 5 Figuren. navyRest[s] = kamera-korrekte
      // Bildschirmposition (Offset zur Mitte) des Navy-Slots in Szene s.
      navyHide.clear();
    ...
    function render() {
      ...
      for (let i = 0; i < els.length; i++) {
        ...
        // Original-Navy-Teile verstecken — der Traveler ersetzt sie an gleicher Stelle.
      ...
      // Navy-Traveler: EIN Teil durch alle 5 Figuren — ruht im Slot jeder Szene,
      // gleitet sanft (masterEase) zur naechsten. Erscheint mit Szene 0, faded am
      // Ende raus. So bleibt es sichtbar IMMER DASSELBE Stueck (harmonisch).
