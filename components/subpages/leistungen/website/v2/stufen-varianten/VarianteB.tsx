...
/**
 * Stufen — Variante B: FEATURE-MATRIX MIT STICKY-STUFE.
 * Pro Stufe: links sticky der Stufenname + Kurzbeschreibung + Badge, rechts die
 * Merkmale als vertikale Liste in zwei Spalten. Klick auf ein Merkmal expandiert
 * inline ein Panel ueber beide Spalten (grid-template-rows 0fr -> 1fr). Das aktive
 * Merkmal bekommt roten Punkt + Navy-Hervorhebung, der Rest dimmt (klickgesteuerte
 * Variante der Fundament-Ledger-Mechanik). Copy identisch zu Variante A/C.
 */
