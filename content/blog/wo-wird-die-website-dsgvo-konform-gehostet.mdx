...
excerpt: >-
  DSGVO-konformes Hosting heißt 2026 mehr als ein EU-Serverstandort.
  Entscheidend sind Eigentümerstruktur, Auftragsverarbeitungsvertrag und ein
  kritischer Blick auf jeden US-Dienst.
featuredSnippetTitle: Wo wird meine Website DSGVO-konform gehostet?
featuredSnippet: >-
  DSGVO-konformes Hosting bedeutet 2026: Ihre Website läuft bei einem Hoster mit
  Serverstandort in der EU, idealerweise in Österreich, und Sie schließen mit
  ihm einen Auftragsverarbeitungsvertrag nach Art. 28 DSGVO ab. Entscheidend ist
  nicht nur der Standort, sondern dass weder Hoster noch Subdienstleister der
  Kontrolle US-amerikanischer Behörden unterliegen.
...
sources:
  ...
  - name: >-
      BfDI - Angemessenheitsbeschluss zum EU-U.S. Data Privacy Framework in
      Kraft getreten
    url: >-
      https://www.bfdi.bund.de/SharedDocs/Kurzmeldungen/DE/2023/17_Angemessenheitsbeschluss-EU-US-DPF.html
  - name: >-
      WKO - EU-DSGVO: Mustervertrag für die Auftragsverarbeitung nach Art. 28
      DSGVO
  ...
  - name: >-
      EDPB/EDPS - Initial legal assessment of the impact of the US CLOUD Act on
      the EU (Annex)
    url: >-
...
keyTakeaways:
  - >-
    Standort ist nicht alles. DSGVO-konformes Hosting heißt EU-Serverstandort,
    idealerweise Österreich oder DACH, plus ein Hoster ohne US-Kontrolle. Der
    CLOUD Act greift auch auf EU-Töchter von US-Anbietern durch.
  - >-
    Der Auftragsverarbeitungsvertrag ist Pflicht. Ohne AVV nach Art. 28 DSGVO
    drohen Maßnahmen der Datenschutzbehörde. Der WKO-Mustervertrag zeigt, was
    drinstehen muss.
  - >-
    Zwei Daten merken. Schrems II (16.07.2020) kippte den Privacy Shield. Seit
    10.07.2023 sind US-Transfers unter dem Data Privacy Framework wieder
    möglich, aber nur zu zertifizierten Empfängern.
  - >-
    Art. 48 DSGVO schützt Sie. Ein US-Behördenbeschluss ist ohne internationales
    Abkommen nicht anzuerkennen, und ein solches Abkommen für den
    Strafverfolgungszugriff gibt es nicht.
  - >-
    Die Verantwortung bleibt bei Ihnen. Sie wählen Hoster und Subdienstleister
    aus. Standort, Anbieter und Subdienstleister müssen zusammen konform sein.
conclusionStats:
...
customFAQs:
  - question: Reicht ein Serverstandort in Deutschland für DSGVO-Konformität aus?
    answer: >-
      Nein. Entscheidend ist die Kontrolle über die Daten, nicht der Standort
      des Rechenzentrums. Gehört der Hoster einer US-Muttergesellschaft, kann
      der CLOUD Act die Datenherausgabe auch dann erzwingen, wenn der Server in
      Frankfurt oder Amsterdam steht.
  - question: >-
      Brauche ich für eine kleine Website wirklich einen
      Auftragsverarbeitungsvertrag?
    answer: >-
      Ja. Auch eine schlichte Visitenkarten-Website verarbeitet über Server-Logs
      personenbezogene Daten wie IP-Adressen. Der AVV nach Art. 28 DSGVO ist
      keine Frage der Größe, sondern der Tatsache, dass ein Dritter für Sie
      Daten verarbeitet.
  - question: >-
      Darf ich seit dem Data Privacy Framework 2023 wieder alle US-Dienste
      nutzen?
    answer: >-
      Nur, wenn der konkrete Dienst unter dem EU-U.S. Data Privacy Framework
      zertifiziert ist. Das gilt pro Dienst und muss im Einzelfall geprüft
      werden, nicht pauschal für alle US-Anbieter angenommen werden.
  - question: 'Wer haftet, wenn das Hosting nicht DSGVO-konform ist, ich oder der Hoster?'
    answer: >-
      Für die Auswahl eines geeigneten Auftragsverarbeiters sind Sie als
      Betreiber verantwortlich. Standort, Anbieter und dessen Subdienstleister
      müssen zusammen konform sein. Die Auswahlpflicht bleibt bei Ihnen.
  - question: Woran erkenne ich einen DSGVO-konformen Hoster?
    answer: >-
      An einem EU-Serverstandort, idealerweise in Österreich oder der
      DACH-Region, einer Eigentümerstruktur ohne US-Mutter, einem
      bereitgestellten AVV nach Art. 28 DSGVO und transparenter Auskunft über
...
<SimpleAudioPlayer src="/audio/wo-wird-die-website-dsgvo-konform-gehostet-podcast.mp3" title="Podcast: DSGVO-konformes Hosting 2026: Wo darf die Website stehen?" />

<VideoEmbed src="/videos/wo-wird-die-website-dsgvo-konform-gehostet-video.mp4" poster="/videos/wo-wird-die-website-dsgvo-konform-gehostet-poster.jpg" id="16M8riAN8TQ" title="Video: DSGVO-konformes Hosting 2026: Wo darf die Website stehen?" />
...
![DSGVO-konformes Hosting 2026](/images/blog/wo-wird-die-website-dsgvo-konform-gehostet-infografik-hfwh7.png)
...
![Beraterin erklaert einem Kunden im Gespraech, worauf es beim DSGVO-konformen Hosting jenseits des reinen Serverstandorts ankommt](/images/blog/wo-wird-die-website-dsgvo-konform-gehostet-ctx1-hfwyv.png)
...
![Haende unterschreiben einen ausgedruckten Auftragsverarbeitungsvertrag als Pflichtdokument fuer DSGVO-konformes Hosting](/images/blog/wo-wird-die-website-dsgvo-konform-gehostet-ctx2-hfwyx.png)
...
![Selbststaendige Floristin prueft in ihrem kleinen Geschaeft die eigene Website - Alltag beim DSGVO-konformen Hosting fuer kleine Betriebe](/images/blog/wo-wird-die-website-dsgvo-konform-gehostet-ctx3-hfwyy.png)
