...
excerpt: "Müssen Sie Bilder und Grafiken für Ihre neue Website selbst liefern? Ein ehrlicher Leitfaden zu Pflicht, Kür, Lizenzen und den teuersten Fallen für österreichische KMU."
featuredSnippetTitle: "Müssen Bilder und Grafiken für die Website selbst geliefert werden?"
featuredSnippet: "Nein, Sie müssen Bilder und Grafiken nicht zwingend selbst liefern. Eine Agentur kann Stockfotos lizenzieren, KI-Visuals erstellen oder einen Fotografen beauftragen. Eigene Fotos von Team, Räumen und Produkten wirken jedoch glaubwürdiger, sparen Lizenzkosten und vermeiden rechtliche Risiken. Liefern Sie, was Sie haben, der Rest wird ergänzt."
...
sources:
  - name: "DS Law - Grundsatzurteil zum Recht am eigenen Bild im Arbeitsverhältnis"
    url: "https://www.ds-law.eu/grundsatzurteil-zum-recht-am-eigenen-bild-im-arbeitsverhaeltnis-einwilligung-und-datenschutz/"
  - name: "Tonninger & Schermaier - Bilder & Fotos auf Website / Social Media rechtssicher"
    url: "https://ts.at/wissen/urheberrecht/bilder-fotos-website-social-media-rechtssicher/"
  - name: "Magaziniker - Der richtige Umgang mit Lizenzen für Stockbilder"
    url: "https://magaziniker.de/umgang-mit-lizenzen-fuer-stockbilder-im-corporate-publishing/"
  - name: "Q2E Online-Agentur - Urheberrecht & Bildrechte auf Websites"
    url: "https://www.q2e.at/blog/urheberrecht-und-bildrechte-auf-websites-haeufige-fragen"
...
keyTakeaways:
  - "Sie müssen Bilder nicht zwingend selbst liefern, aber bestehendes Material wie Logo, Teamfotos und Produktbilder gehört in jedes Briefing."
  - "Eigene Fotos schlagen Stockfotos und KI-Bilder in fast jedem lokalen Geschäftskontext, ein einmaliger Foto-Termin lohnt sich meist."
  - "Bildnisschutz nach § 78 UrhG verlangt schriftliche Einwilligungen für Mitarbeiter- und Kundenfotos, der OGH wertet fehlende Rückfrage als Rechtsverletzung."
  - "Stockfoto-Lizenzen sind an die kaufende Person gebunden, lassen Sie den Account auf Ihren Namen anlegen, nicht auf den der Agentur."
  - "Fehlende Inhalte sind die Nummer-eins-Ursache für Projektverzögerungen, beginnen Sie die Material-Sammlung vor dem ersten Briefing."
conclusionStats:
...
customFAQs:
  - question: "Muss ich Bilder für meine neue Website selbst liefern?"
    answer: "Nein, Pflicht ist es nicht. Eine Agentur kann Stockfotos lizenzieren, KI-Visuals erstellen oder einen Fotografen beauftragen. Eigene Fotos von Team, Räumen und Produkten wirken jedoch glaubwürdiger und sparen Folgekosten. Liefern Sie, was vorhanden ist, der Rest wird ergänzt."
  - question: "Was passiert, wenn ich ein Bild aus Google oder Social Media verwende?"
    answer: "Das ist eine Urheberrechtsverletzung. Auch wenn die Quelle genannt wird oder Sie verlinkt wurden, brauchen Sie eine ausdrückliche Nutzungslizenz. Spezialisierte Kanzleien scannen das Netz, Abmahnungen kosten schnell mehrere hundert bis tausend Euro plus Anwaltskosten."
  - question: "Darf ich Mitarbeiterfotos ohne Zustimmung auf der Website zeigen?"
    answer: "Nein. § 78 UrhG verlangt eine Einwilligung, für werbliche Nutzung schriftlich. Der OGH hat klargestellt, dass eine Veröffentlichung ohne vorherige Rückfrage als Verletzung des Bildnisschutzes gilt. Holen Sie eine kurze, klare Einwilligung pro Person ein."
  - question: "Wem gehören Stockfoto-Lizenzen, mir oder meiner Agentur?"
    answer: "Lizenzen sind an die kaufende Person oder Firma gebunden und nicht übertragbar. Wenn die Agentur über ihren Account lizenziert, dürfen Sie das Bild später nicht eigenständig weiterverwenden. Best Practice: Account auf Ihren Namen anlegen, dann gehören die Lizenzen Ihnen."
  - question: "Sind KI-generierte Bilder eine sichere Alternative?"
    answer: "Für Konzept-Visuals und Stimmungsbilder ja, als Ersatz für echte Menschen oder echte Räume nein. Die Rechtslage zu Trainingsdaten ist nicht abschließend geklärt, Adobe Firefly bietet aktuell das sauberste Modell mit Schadensfreistellung für Geschäftskunden."
hookCandidates:
...
![Bildmaterial-Briefing für die neue Website: Logo, Teamfotos und Produktbilder ordentlich vorbereitet](/images/blog/muessen-bilder-und-grafiken-selbst-geliefert-werden.png)
