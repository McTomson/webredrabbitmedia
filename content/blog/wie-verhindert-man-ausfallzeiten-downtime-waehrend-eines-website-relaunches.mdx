...
excerpt: >-
  Wie Sie einen Website-Relaunch ohne Ausfallzeiten planen: DNS-TTL rechtzeitig
  absenken, eine vollständige 301-Redirect-Map anlegen und den Go-Live über
  einen atomaren Umschaltvorgang durchführen statt über eine manuelle
  Serverumstellung.
featuredSnippetTitle: Wie verhindert man Ausfallzeiten (Downtime) während eines Website-Relaunches?
featuredSnippet: >-
  Ausfallzeiten beim Relaunch verhindert man, indem man die neue Website zuerst
  vollständig isoliert testet, die DNS-TTL vorab absenkt, eine komplette
  301-Redirect-Map von alten auf neue URLs erstellt und den Go-Live über einen
  atomaren Umschaltvorgang laufen lässt statt über eine manuelle
  Serverumstellung.
...
tags:
  ...
  - Vercel Deployment
featuredImage: >-
  /images/blog/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches.png
status: published
chosenHook: 'relaunch: alte links noch gueltig?'
aiAssisted: true
sources:
...
keyTakeaways:
  - >-
    TTL des DNS-Eintrags mindestens 48 bis 72 Stunden vor dem Go-Live absenken,
    danach wieder erhöhen.
  - >-
    Vollständige 1:1-Redirect-Map (alte URL zu neuer URL) mit dauerhaften
    301-Weiterleitungen erstellen, keine pauschale Weiterleitung auf die
    Startseite.
  - >-
    Neue Website zuerst komplett in einer Staging- oder Preview-Umgebung testen,
    erst nach Freigabe live schalten.
  - >-
    Bei Domain-Wechsel das Change-of-Address-Tool in der Google Search Console
    nutzen, um den Übergang der Ranking-Signale zu unterstützen.
  - >-
    Auf eine Deployment-Plattform mit atomarem Alias-Swap setzen und nach dem
    Go-Live mindestens 48 Stunden aktiv Traffic und Fehler beobachten.
autoGenerateFAQs: false
customFAQs:
  - question: Wie lange sollte die TTL vor einem Website-Relaunch abgesenkt werden?
    answer: >-
      Idealerweise 48 bis 72 Stunden vor dem geplanten Go-Live, damit
      DNS-Resolver weltweit den neuen, niedrigeren Wert bereits übernommen
      haben, bevor die eigentliche Umstellung passiert.
  - question: Was ist eine 301-Redirect-Map und warum ist sie beim Relaunch wichtig?
    answer: >-
      Eine 301-Redirect-Map ist eine vollständige Liste, die jede alte URL auf
      die passende neue URL weiterleitet. Sie verhindert Fehlerseiten für
      Besucher und schützt gleichzeitig das bestehende Google-Ranking.
  - question: Was macht das Change-of-Address-Tool in der Google Search Console?
    answer: >-
      Es signalisiert Google aktiv, dass eine Domain umzieht, sodass die neue
      Adresse bevorzugt gecrawlt wird und Ranking-Signale schneller von der
      alten auf die neue Domain übertragen werden.
  - question: >-
      Warum verhindert ein atomarer Alias-Swap Ausfallzeiten besser als eine
      manuelle Serverumstellung?
    answer: >-
      Weil die Umstellung auf die neue Version in unter einer Sekunde passiert
      und laufende Anfragen auf der alten Version noch sauber zu Ende bedient
      werden, statt dass für Minuten ein instabiler Zwischenzustand entsteht.
  - question: Wie lange sollte man nach einem Relaunch das Monitoring aktiv betreiben?
    answer: >-
      Mindestens 48 Stunden lang, mit regelmäßiger Prüfung von Erreichbarkeit,
      Formularen, Ladezeiten und der Google Search Console, um Probleme früh zu
      erkennen statt erst Wochen später.
hookCandidates:
...
<SimpleAudioPlayer src="/audio/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches-podcast.mp3" title="Podcast: Downtime beim Website-Relaunch vermeiden 2026" />

<VideoEmbed src="/videos/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches-video.mp4" poster="/videos/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches-poster.jpg" id="htCkCs1nShs" title="Video: Downtime beim Website-Relaunch vermeiden 2026" />
...
![Relaunch ohne Ausfallzeit](/images/blog/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches-infografik-kz8qh.png)
...
![Beraterin und Unternehmer planen am Wandkalender die DNS-TTL-Absenkung mehrere Tage vor dem Website-Relaunch](/images/blog/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches-ctx1-kzat4.png)
...
![Hände prüfen eine ausgedruckte 301-Redirect-Tabelle Zeile für Zeile mit Textmarker für den Website-Relaunch](/images/blog/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches-ctx2-kzat7.png)
...
![Webentwickler beobachtet nach dem Go-Live des Website-Relaunchs die Monitoring-Dashboards am Abend im Büro](/images/blog/wie-verhindert-man-ausfallzeiten-downtime-waehrend-eines-website-relaunches-ctx3-kzata.png)
