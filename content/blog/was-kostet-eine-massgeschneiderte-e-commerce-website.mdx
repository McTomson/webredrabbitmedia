...
Plötzlich sieht der einmalige Eigenbau für 8.000 Euro gar nicht mehr so teuer aus, oder? Meine Empfehlung: Für den schnellen Test einer Geschäftsidee ist ein Mietshop völlig in Ordnung. Wer ernsthaft und langfristig verkauft, sollte einmal sauber durchrechnen, ab wann sich die Eigenentwicklung gegenüber der monatlichen Miete rechnet. Dieselbe Logik gilt für jede Website: Wann sich das [Investment in eine neue Website amortisiert](/tipps/ab-wann-rechnet-sich-das-investment-in-eine-neue), lässt sich mit wenigen Variablen seriös beantworten. Bei stabilem Umsatz ist dieser Punkt oft schneller erreicht, als man denkt.
...
Mit folgenden laufenden Kosten sollten Sie in Österreich planen: Hosting kostet 20 bis 80 Euro pro Monat, ein Wartungspaket 80 bis 250 Euro pro Monat, Plugin-Lizenzen 200 bis 800 Euro pro Jahr. Wie hoch die [laufenden Kosten für Webhosting und Domain](/tipps/wie-hoch-sind-die-laufenden-kosten-fuer-webhosting-und) bei einer normalen Geschäfts-Website ausfallen, haben wir mit echten österreichischen Preisen aufgeschlüsselt. Dazu kommen Zahlungsgebühren von 1,4 bis 2,9 Prozent pro Transaktion, die direkt von jedem Verkauf abgehen.
